...
def main():
    ...
    sns.distplot(df['Sepal-Length'], hist = True, kde = False, color='red')
    sns.distplot(df1['Sepal-Length'], hist = True, kde = False, color='green')
    sns.distplot(df2['Sepal-Length'], hist = True, kde = False, color='blue')
    plt.legend()
    plt.show()
