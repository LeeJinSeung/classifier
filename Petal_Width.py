...
def main():
    ...
    sns.distplot(df['Petal-Width'], hist = True, kde = False, color='red')
    sns.distplot(df1['Petal-Width'], hist = True, kde = False, color='green')
    sns.distplot(df2['Petal-Width'], hist = True, kde = False, color='blue')
    plt.legend()
    plt.show()
